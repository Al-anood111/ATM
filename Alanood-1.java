...
public class Alanood {
    ...
    public static void addNewUser(){
        ...
        if(flag == false){
            ...
            System.out.println("account number is existing, try again!");
        }
        }while(flag == true);
    }
        ...
        { 
            ...
            case 3:
                ...
                while(withdrawAmt > currentBalance){
                    System.out.print("your current balance lessthan withdraw .."
